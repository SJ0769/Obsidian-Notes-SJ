...
- **(Extended) Modal Realism** is the view that impossible worlds  also exist, which allow contradictions. These worlds would operate on paraconsistent (and even fully trivialist) logics.


A being operating on trivialist logic would be omnipotent, (this is also a valid solution the omnipotence paradox)


**Compatibilism:** The view that free will exists and determinism (which is the view that our fate is determined, or that our will is determined by past experiences, we cannot will what we will)
